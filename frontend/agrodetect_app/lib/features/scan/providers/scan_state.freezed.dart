...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  idle,TResult Function( double progress)?  loading,TResult Function( PredictionResult result)?  success,TResult Function( String message)?  error,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Idle() when idle != null:
return idle();case _Loading() when loading != null:
return loading(_that.progress);case _Success() when success != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  idle,required TResult Function( double progress)  loading,required TResult Function( PredictionResult result)  success,required TResult Function( String message)  error,}) {final _that = this;
switch (_that) {
case _Idle():
return idle();case _Loading():
return loading(_that.progress);case _Success():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  idle,TResult? Function( double progress)?  loading,TResult? Function( PredictionResult result)?  success,TResult? Function( String message)?  error,}) {final _that = this;
switch (_that) {
case _Idle() when idle != null:
return idle();case _Loading() when loading != null:
return loading(_that.progress);case _Success() when success != null:
...
class _Idle implements ScanState {
  const _Idle();
...
@override
String toString() {
  return 'ScanState.loading(progress: $progress)';
}
...
/// @nodoc
abstract mixin class _$LoadingCopyWith<$Res> implements $ScanStateCopyWith<$Res> {
...
$PredictionResultCopyWith<$Res> get result {
  ...
  return $PredictionResultCopyWith<$Res>(_self.result, (value) {
